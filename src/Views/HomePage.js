      ...
      <div className="flex flex-col min-h-screen">
        <div className="bg-gray-800">
          <div className="p-5 border-b border-gray-700 flex items-center justify-between">
            <button className="border border-gray-500 text-gray-400 px-4 py-2 rounded-full inline-flex items-center hover:bg-gray-600 hover:text-white">
              <svg
          ...
          <div className="container mx-auto">
            <div className="flex flex-wrap py-8 flex-col sm:flex-row">
              ...
              <div className="sm:pl-10 sm:pt-4 flex-1">
                <div className="flex sm:justify-between sm:flex-row sm:flex-no-wrap justify-center flex-wrap mb-6">
                  <div className="flex flex-wrap md:w-auto w-full md:mb-0 mb-4">
                    ...
                    <div className="flex sm:w-auto w-full sm:justify-start justify-center">
                      ...
                      <span className="text-gray-600 mr-4 tracking-wider">
                        <span className="text-gray-400">yml</span> ✓
                      </span>
                      <span className="text-gray-600 mr-4 tracking-wider">
                    ...
                    <div className="flex sm:w-auto sm:mt-0 mt-4 sm:mb-0 mb-2 w-full sm:justify-start justify-center">
                      <a
                        ...
                        href="https://www.facebook.com/a123.1e/"
                ...
                <p className="text-gray-400 leading-normal px-4 sm:px-0">
                  Việt hóa YAML là quá trình chuyển đổi các tệp YAML từ một ngôn
                  ngữ gốc sang ngôn ngữ đích. YAML (YAML Ain't Markup Language)
                  là một định dạng văn bản dùng để biểu diễn dữ liệu cấu trúc,
                  thường được sử dụng để cấu hình ứng dụng và lưu trữ dữ liệu.
                  Việt hóa YAML thường được sử dụng khi bạn muốn đa ngôn ngữ hóa
                  ứng dụng, trang web, plugins, ... của mình để phục vụ nhiều
                  khách hàng nói nhiều ngôn ngữ khác nhau.
                  <br />
                  <br />
                  Ví dụ:
                  <br />
                  <span className="text-gray-500">
                    <span className="text-gray-400">File gốc: </span>
                    greeting: "Hello, World!"
                  </span>
                  <br />
                  <span className="text-gray-500">
                    <span className="text-gray-400">File việt hóa: </span>
